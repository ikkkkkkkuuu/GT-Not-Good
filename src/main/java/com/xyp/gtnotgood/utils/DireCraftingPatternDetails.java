...
public class DireCraftingPatternDetails implements ICraftingPatternDetails {
    ...
    public static final String SERIALIZED_MULTIPLIER = "gtngMatrixMultiplier";
    ...
    /** Stable value equality lets saved CPU tasks find a newly loaded matrix's equivalent pattern. */
    @Override
    public boolean equals(Object other) {
        return other instanceof DireCraftingPatternDetails details && multiply == details.multiply
            && pattern.isItemEqual(details.pattern)
