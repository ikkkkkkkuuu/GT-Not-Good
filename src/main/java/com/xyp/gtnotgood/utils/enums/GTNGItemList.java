...
public enum GTNGItemList implements IItemContainer {
    ...
    RTS_CRAFT_TERMINAL_PLUGIN,
    RTS_CHAIN_BREAK_PLUGIN,
    RTS_AREA_DESTROY_PLUGIN,
    RTS_BLUEPRINT_PLUGIN,
    RTS_RANGE_CULLING_PLUGIN,
    RTS_FIELD_DEPLOYMENT_PLUGIN,
    RTS_RANGE_EXTENSION_I,
    RTS_RANGE_EXTENSION_II,
    RTS_RANGE_EXTENSION_III,
    RTS_RANGE_EXTENSION_MAX,
    RTS_HARVEST_TIER_STONE,
    RTS_HARVEST_TIER_IRON,
    RTS_HARVEST_TIER_DIAMOND,
    RTS_HARVEST_TIER_UNLIMITED,
    ...
    WirelessLaserEnergyLV_16384,
    WirelessLaserEnergyLV_65536,
    WirelessLaserEnergyLV_262144,
    WirelessLaserEnergyLV_1048576,
    WirelessLaserDynamoLV,
    WirelessLaserEnergyMV_256,
    WirelessLaserEnergyMV_1024,
    WirelessLaserEnergyMV_4096,
    WirelessLaserEnergyMV_16384,
    WirelessLaserEnergyMV_65536,
    WirelessLaserEnergyMV_262144,
    WirelessLaserEnergyMV_1048576,
    WirelessLaserDynamoMV,
    WirelessLaserEnergyHV_256,
    WirelessLaserEnergyHV_1024,
    WirelessLaserEnergyHV_4096,
    WirelessLaserEnergyHV_16384,
    WirelessLaserEnergyHV_65536,
    WirelessLaserEnergyHV_262144,
    WirelessLaserEnergyHV_1048576,
    WirelessLaserDynamoHV,
    WirelessLaserEnergyEV_256,
    WirelessLaserEnergyEV_1024,
    WirelessLaserEnergyEV_4096,
    WirelessLaserEnergyEV_16384,
    WirelessLaserEnergyEV_65536,
    WirelessLaserEnergyEV_262144,
    WirelessLaserEnergyEV_1048576,
    WirelessLaserDynamoEV,
    WirelessLaserEnergyIV_256,
    WirelessLaserEnergyIV_1024,
    WirelessLaserEnergyIV_4096,
    WirelessLaserEnergyIV_16384,
    WirelessLaserEnergyIV_65536,
    WirelessLaserEnergyIV_262144,
    WirelessLaserEnergyIV_1048576,
    WirelessLaserDynamoIV,
    WirelessLaserEnergyLuV_256,
    WirelessLaserEnergyLuV_1024,
    WirelessLaserEnergyLuV_4096,
    WirelessLaserEnergyLuV_16384,
    WirelessLaserEnergyLuV_65536,
    WirelessLaserEnergyLuV_262144,
    WirelessLaserEnergyLuV_1048576,
    WirelessLaserDynamoLuV,
    WirelessLaserEnergyZPM_256,
    WirelessLaserEnergyZPM_1024,
    WirelessLaserEnergyZPM_4096,
    WirelessLaserEnergyZPM_16384,
    WirelessLaserEnergyZPM_65536,
    WirelessLaserEnergyZPM_262144,
    WirelessLaserEnergyZPM_1048576,
    WirelessLaserDynamoZPM,
    WirelessLaserEnergyUV_256,
    WirelessLaserEnergyUV_1024,
    WirelessLaserEnergyUV_4096,
    WirelessLaserEnergyUV_16384,
    WirelessLaserEnergyUV_65536,
    WirelessLaserEnergyUV_262144,
    WirelessLaserEnergyUV_1048576,
    WirelessLaserDynamoUV,
    WirelessLaserEnergyUHV_256,
    WirelessLaserEnergyUHV_1024,
    WirelessLaserEnergyUHV_4096,
    WirelessLaserEnergyUHV_16384,
    WirelessLaserEnergyUHV_65536,
    WirelessLaserEnergyUHV_262144,
    WirelessLaserEnergyUHV_1048576,
    WirelessLaserDynamoUHV,
    WirelessLaserEnergyUEV_256,
    WirelessLaserEnergyUEV_1024,
    WirelessLaserEnergyUEV_4096,
    WirelessLaserEnergyUEV_16384,
    WirelessLaserEnergyUEV_65536,
    WirelessLaserEnergyUEV_262144,
    WirelessLaserEnergyUEV_1048576,
    WirelessLaserDynamoUEV,
    WirelessLaserEnergyUIV_256,
    WirelessLaserEnergyUIV_1024,
    WirelessLaserEnergyUIV_4096,
    WirelessLaserEnergyUIV_16384,
    WirelessLaserEnergyUIV_65536,
    WirelessLaserEnergyUIV_262144,
    WirelessLaserEnergyUIV_1048576,
    WirelessLaserDynamoUIV,
    WirelessLaserEnergyUMV_256,
    WirelessLaserEnergyUMV_1024,
    WirelessLaserEnergyUMV_4096,
    WirelessLaserEnergyUMV_16384,
    WirelessLaserEnergyUMV_65536,
    WirelessLaserEnergyUMV_262144,
    WirelessLaserEnergyUMV_1048576,
    WirelessLaserDynamoUMV,
    WirelessLaserEnergyUXV_256,
    WirelessLaserEnergyUXV_1024,
    WirelessLaserEnergyUXV_4096,
    WirelessLaserEnergyUXV_16384,
    WirelessLaserEnergyUXV_65536,
    WirelessLaserEnergyUXV_262144,
    WirelessLaserEnergyUXV_1048576,
    WirelessLaserDynamoUXV,
    WirelessLaserEnergyMAX_256,
    WirelessLaserEnergyMAX_1024,
    WirelessLaserEnergyMAX_4096,
    WirelessLaserEnergyMAX_16384,
    WirelessLaserEnergyMAX_65536,
    WirelessLaserEnergyMAX_262144,
    WirelessLaserEnergyMAX_1048576,
