...
public final class UpgradesPanel implements ICompositeWidget {
    ...
    private static final Blitter INNER_CORNER = BACKGROUND.copy()
        .src(12, 33, SLOT_SIZE, SLOT_SIZE);
    ...
    public void drawBackgroundLayer(GuiGraphics guiGraphics, Rect2i bounds, Point mouse) {
        ...
        for (int i = 0; i < slotCount; i++) {
            ...
            if (col > 0 && lastSlot && !lastRow) {
                INNER_CORNER.dest(x, y + SLOT_SIZE)
                    .blit(guiGraphics);
            }
        }
    ...
    public void addExclusionZones(List<Rect2i> exclusionZones, Rect2i screenBounds) {
        ...
        if (fullCols > 0) {
            ...
            exclusionZones.add(
                Rects.expand(
                    new Rect2i(rightEdge, offsetY + y, fullColWidth, PADDING * 2 + MAX_ROWS * SLOT_SIZE),
                    margin));
    ...
    private static void drawSlot(GuiGraphics guiGraphics, int x, int y, boolean borderLeft, boolean borderTop,
